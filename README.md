...
- Complete 2FA setup (email code)
- Save revocation code in a safe place

**Note**: Manual `.maFile` import is not available in the UI. Accounts can be added by placing `.maFile` directly in the `mafile/` directory.
...
⚠️ **Warning**: Proxy functionality is not fully tested. Use at your own risk.
